...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        ...
        for word in sent:
            ...
            current_word_length = len(padded_word)
            padded_word += [char_pad_token] * (max_word_length - current_word_length)
            padded_sent.append(padded_word)
        current_sent_length = len(padded_sent)
        padded_sent += [[char_pad_token] * max_word_length] * (max_sent_length - current_sent_length)
...
def pad_sents(sents, pad_token):
    ...
    for i, sent in enumerate(sents):
        current_sentence = sent.copy()
        for _ in range(max_length - len(sent)):
            current_sentence.append(pad_token)
